    ...
    public static void setViewBackground(
        ...
        if (count < 1) {
            ...
            if (count == 1 && !isDefaultNull) {
                ...
                com.org.hlyx.support.ext.bindadapter.ProxyDrawable listDrawable = new com.org.hlyx.support.ext.bindadapter.ProxyDrawable();
                if (checkedDrawable != null) {
                ...
                if (defaultDrawable != null) {
                    ...
                    if (originDrawable != null) {
                        if (originDrawable instanceof com.org.hlyx.support.ext.bindadapter.ProxyDrawable) {
                            originDrawable = ((com.org.hlyx.support.ext.bindadapter.ProxyDrawable) originDrawable).getOriginDrawable();
                        }
