package com.org.hlyx.support.util
...
import com.org.hlyx.support.event.loadCallBack.LoadingCallback
...
object SettingUtil {
    ...
    fun getLanguageText(lc: String): String {
        when (lc) {
            Locale.SIMPLIFIED_CHINESE.country -> return "中文"
            Locale.ENGLISH.country -> return "English"
        }
        return "中文"
    }

    fun getLanguageTag(lc: String): String {
        when (lc) {
            Locale.SIMPLIFIED_CHINESE.country -> return "zh-Hans"
            Locale.ENGLISH.country -> return "en"
        }
        return "zh-Hans"
    }

    fun getLanguageLocale(lc: String): Locale {
        when (lc) {
            Locale.SIMPLIFIED_CHINESE.country -> return Locale.SIMPLIFIED_CHINESE
            Locale.ENGLISH.country -> return Locale.ENGLISH
        }
