package com.mvvm.plus.support.ext.bindadapter;
    ...
    public static void setViewBackground(
        ...
        if (count < 1) {
            ...
            if (count == 1 && !isDefaultNull) {
                ...
                com.mvvm.plus.support.ext.bindadapter.ProxyDrawable listDrawable = new com.mvvm.plus.support.ext.bindadapter.ProxyDrawable();
                if (checkedDrawable != null) {
                ...
                if (defaultDrawable != null) {
                    ...
                    if (originDrawable != null) {
                        if (originDrawable instanceof com.mvvm.plus.support.ext.bindadapter.ProxyDrawable) {
                            originDrawable = ((com.mvvm.plus.support.ext.bindadapter.ProxyDrawable) originDrawable).getOriginDrawable();
                        }
